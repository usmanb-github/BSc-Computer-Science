 ...
 * @author ub2232e
 */
public class Between extends JFrame implements ActionListener {
    ...
    ModelGraph BetweenGraph = new ModelGraph();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == submit) {
            //inputting values
            BetweenGraph.setMean(meanValue);
            BetweenGraph.setSD(sdValue);
            BetweenGraph.setBetweenValueOne(valueOne);
            BetweenGraph.setBetweenValueTwo(valueTwo);
            BetweenGraph.setOption("3");
            ...
            switch (message) {
                case "Trapezoidal Method":
                    area.setText("Trapezoidal Area:" + "" + ModelCalculations.trapRule(valueOne, valueTwo, strips, meanValue, sdValue));
                    break;
                case "Rectangular Method":
                    area.setText("Rectangular Area:" + "" + (ModelCalculations.rectRule(valueOne, valueTwo, strips, meanValue, sdValue)));
                    break;
                default:
